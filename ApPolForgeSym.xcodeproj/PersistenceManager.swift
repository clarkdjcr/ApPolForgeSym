...
class PersistenceManager {
    ...
    private init() {
        ...
        // Register for app termination to trigger cleanup
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(cleanupSession),
            name: NSNotification.Name("NSApplicationWillTerminateNotification"),
            object: nil
        )
    }
    
    /// Cleanup sensitive data on app termination
    @objc private func cleanupSession() {
