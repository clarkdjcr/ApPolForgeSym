...
- **Actions Per Turn**: Each player takes one action per turn and reviews outcome during next players turn.
...
#### Campaign Funds
- Starting: $15M (Incumbent) / $15M (Challenger)
- Used to: Execute campaign actions
- Used to hire and trai staff
- Used to open and support campaign offices in specific states
- Used for travel expences for candidates and staff
...
### 2. Electoral Map
The game features an electoral map with:
- **14 States** representing key battlegrounds and strongholds
- **538 Total Electoral Votes** distributed among all states
- **State-Level Polling** tracking support for each candidate
- **Complete table showing all states and their polling numbers and their electoral college predicted values
...
- **If illeagl offences are discoveed create media event and urge immediate disqualification
...
- **Actions**: Ad campaigns, rallies, opposition research, shadow practices
...
- **Actions**: Town halls, grassroots organizing, responces to specific media events good or bad
...
- **Risk**: Engage in illeagl activities that are possible discoverable offences
...
- **Create helper files to assist player review of media activity
